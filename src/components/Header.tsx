    ...
    <header className="justify-between items-center flex w-full leading-none flex-wrap bg-[#FCFCFF] px-16 py-6 max-md:max-w-full max-md:px-5">
      ...
      <nav className="self-stretch flex min-w-60 items-center gap-6 font-medium text-center flex-wrap my-auto max-md:max-w-full">
        <div className="self-stretch flex min-w-60 items-center gap-6 text-lg text-[#130231] tracking-[-0.09px] my-auto max-md:max-w-full">
          <Link to="/" className="text-[#130231] self-stretch my-auto hover:text-blue-600 transition-colors">
            Home
          </Link>
          <Link to="/about" className="text-[#130231] self-stretch my-auto hover:text-blue-600 transition-colors">
            About us
          </Link>
          <Link to="/projects" className="text-[#130231] self-stretch my-auto hover:text-blue-600 transition-colors">
            Projects
          </Link>
          <Link to="/service" className="text-[#130231] self-stretch my-auto hover:text-blue-600 transition-colors">
            Service
          </Link>
          <Link to="/contact" className="text-[#130231] self-stretch my-auto hover:text-blue-600 transition-colors">
            Contact
          </Link>
        </div>
        
        <button className="justify-center items-center self-stretch flex min-h-12 gap-2 text-base text-[#FCFCFF] tracking-[-0.08px] my-auto px-4 py-[13px] rounded-[11.25px] bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 transition-all">
